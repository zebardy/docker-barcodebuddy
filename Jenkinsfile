pipeline {
  ...
  environment {
    ...
    EXT_USER = 'Forceu'
    EXT_REPO = 'barcodebuddy'
    BUILD_VERSION_ARG = 'BARCODEBUDDY_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-barcodebuddy'
    CONTAINER_NAME = 'barcodebuddy'
    DOCKERHUB_IMAGE = 'zebardy/barcodebuddy'
#    DEV_DOCKERHUB_IMAGE = 'lsiodev/barcodebuddy'
#    PR_DOCKERHUB_IMAGE = 'lspipepr/barcodebuddy'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
